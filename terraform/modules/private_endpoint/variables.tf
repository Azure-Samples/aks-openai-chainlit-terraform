variable "name" {
  description = "(Required) Specifies the name of the Azure Private Endpoint. Changing this forces a new resource to be created."
  type        = string
}
...
variable "tags" {
  description = "(Optional) Specifies the tags of the Azure Azure Private Endpoint."
  default     = {}
}
