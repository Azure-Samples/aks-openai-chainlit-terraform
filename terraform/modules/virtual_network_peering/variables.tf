...
variable "vnet_1_rg" {
  description = "Specifies the name of the resource group. of the first virtual network"
  type        = string
}
...
variable "vnet_2_rg" {
  description = "Specifies the name of the resource group. of the second virtual network"
  type        = string
}
