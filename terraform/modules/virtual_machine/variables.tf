variable resource_group_name {
  description = "(Required) Specifies the name of the resource group. of the virtual machine"
  type = string
}
...
variable "tags" {
  description = "(Optional) Specifies the tags of the Azure Virtual Machine resource."
  default     = {}
}
